...
# Interpretação:
# Uma semana com menos de 35 conversões parece relativamente rara
# nas simulações, indicando que esse resultado pode ser um sinal
# de possível problema na campanha e não apenas uma variação comum
# do processo.
...
# Interpretação:
# A capacidade de 22 clientes por hora parece a mais razoável.
# A capacidade de 20 reduz a ociosidade, mas aumenta bastante a
# saturação e o número de clientes excedentes. Já a capacidade de 25
# reduz muito a saturação, porém gera maior ociosidade. Assim, 22
# representa um equilíbrio mais adequado entre eficiência operacional
